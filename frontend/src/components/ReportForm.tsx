...
import { reportAPI, type ApiError } from "../services/api";
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                A case officer will review your report. If it's verified, it will be forwarded to the appropriate authorities.
              </p>
